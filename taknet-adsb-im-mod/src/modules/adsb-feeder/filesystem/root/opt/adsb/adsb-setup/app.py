...
class AdsbIm:
    def __init__(self):
        ...
        self._other_aggregators = {
            ...
            "taknet--submit": TaknetPS(self._system),
        }
        # fmt: off
        ...
        self.microfeeder_setting_tags = (
            ...
            "taknet--is_enabled", "taknet--host", "taknet--port",
        )
                ...
                if allow_insecure and key == "tailscale":
                    ...
                    if ts_args:
                        ...
                        if not match:
                            ...
                            continue
                    print_err(f"starting tailscale (args='{ts_args}', authkey={'provided' if ts_authkey else 'not provided'})")
                    try:
                        subprocess.run(
                        ...
                        # Add auth key if provided - this enables automatic authentication
                        if ts_authkey:
                        ...
                        if ts_authkey:
                            ...
                            if result.returncode == 0:
                                ...
                                report_issue(f"Failed to connect with auth key. Please check your auth key and try again.")
                        ...
                        if not ts_authkey:
                            # Only look for login link if no auth key was provided
                            startTime = time.time()
                            match = None
